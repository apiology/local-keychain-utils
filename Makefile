...
release: dist ## package and upload a release
	...
	twine upload -u $$(with-op op get item 'PyPI - test' --fields username) -p $$(with-op op get item 'PyPI - test' --fields password) dist/local_keychain_utils-$${new_version:?}.tar.gz -r testpypi; \
	twine upload -u $$(with-op op get item 'PyPI' --fields username) -p $$(with-op op get item 'PyPI' --fields password) dist/local_keychain_utils-$${new_version:?}.tar.gz -r pypi
